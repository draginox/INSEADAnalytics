...
## NOTES
# After PCA, we find a bunch of variables that are Principal Components
# Use the highest factor loading in each PrinComp and let that be the one of the segmentation_attributes_used ^^
...
## NOTES
# let the elbow rule help with # clusters above ^
...
## NOTES
# this is the criterion for distance BETWEEN groups
# DEFAULT is "ward"
...
## NOTES
# method = hclust_method depends on which method you selected!
# Display dendogram
...
## NOTES
# in the height plot, you start on the right hand side and keep walking to the left UNTIL you have an elbow - 5 and 4 as an example (lots of cost moving from 5 to 4); pick 5 in this case
# could be 8 to 7 as well! Have to iterate A LOT
```
...
## NOTES
# numb_clusters_used is where you MANUALLY select the number of clusters you want
